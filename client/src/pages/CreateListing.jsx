...
export default function CreateListing() {
  ...
  const handleImageSubmit = async (e) => {
    ...
    if (files.length === 0) {
      return setImageUploadError("Please select images first");
    }
    ...
    try {
      ...
      const res = await fetch("/api/upload/listings", {
        method: "POST",
      ...
      setImageUploadError("Upload failed 1");
      setUploading(false);
    }
  };
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4">
            <input
              ...
              className="p-3 border-gray-700 border rounded w-full"
              type="file"
              id="image"
              accept="image/*"
              multiple
